...
def null_setter(result):
    ...
    if result or result in ALLOWED_TYPES:
        return result
    return NULL_VALUE
...
class IgnoreFieldMiddleware:
    ...
    # TODO:- Need to be removed with protobuf>=3.12, i.e. once fields set with
    # default value can be recognised as set (using 'optional' flag).
    PROTOBUF_DEFAULT_SET = {
        'latest_message',
        'mean_elapsed_time',
        'is_held',
        'is_held_total',
    ...
    def resolve(self, next, root, info, **args):
        ...
        if args[STRIP_ARG]:
            if (
                    ...
                    and field_name not in self.PROTOBUF_DEFAULT_SET
